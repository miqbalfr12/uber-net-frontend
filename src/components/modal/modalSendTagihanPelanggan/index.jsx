...
const ModalSendTagihanPelanggan = ({
 open,
 handler,
 color,
 refreshData,
 ...
 const handleSub = async (e) => {
  ...
  setLoading(true);
  const send = await fetch(`/api/v1.0.0/send/tagihan`, {
   method: "POST",
   headers: {
   ...
   <Modal
    ...
    <form
     ...
     <div
      ...
      <p className="text-xl font-semibold">KIRIM TAGIHAN</p>
      <button
       type="button"
       onClick={handler}>
       <X />
     ...
     <div className="flex flex-col gap-4 mb-4">
      <div className="flex flex-wrap w-full gap-2 md:flex-nowrap">
       <p>
        Apakah anda yakin ingin mengirim informasi tagihan ke setiap pelanggan
...
export default ModalSendTagihanPelanggan;
