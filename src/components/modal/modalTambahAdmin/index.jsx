 ...
 return (
  <>
   <Modal
    ...
    <form
     ...
     <div
      ...
      <p className="text-xl font-semibold">TAMBAH USER ADMIN</p>
      <button
       type="button"
       onClick={handler}>
       <X />
     ...
     <div className="flex flex-col gap-4 mb-4">
      <div>
       <p className="text-xl font-semibold">Informasi Admin</p>
       <p>Lengkapi Informasi Admin</p>
      </div>
   ...
   <ModalSuccess
    ...
    Buat Akun Admin Berhasil Disimpan
   </ModalSuccess>
   <ModalFailed
    open={openSub === "Failed"}
    handler={() => {
